...
class _$DoOrderImpl implements _DoOrder {
  const _$DoOrderImpl(this.model);
...
abstract class _DoOrder implements OrderEvent {
  const factory _DoOrder(final OrderRequestModel model) = _$DoOrderImpl;
...
abstract class _Loaded implements OrderState {
  const factory _Loaded(final OrderResponseModel model) = _$LoadedImpl;
